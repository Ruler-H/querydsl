...
public class QuerydslBasicTest {
    ...
    @Test
    public void fetchFirst() throws Exception {
    ...
    @Test
    public void fetchCount() throws Exception {
        long l = queryFactory
                .selectFrom(member)
                .fetchCount();
    }
    ...
    public void subQuerySelect() throws Exception {
        ...
        for (Tuple tuple : result) {
            ...
            System.out.println("tuple.get(JPAExpressions.select()) = "
    ...
    @Test
    public void sortCase() throws Exception {
    ...
    @Test
    public void useConstant() throws Exception {
